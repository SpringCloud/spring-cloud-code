...
import cn.springcloud.book.consul.override.consumer.myconsultool.MyConsulServerList;
...
@RestController
@EnableFeignClients
public class NewConsulConsumerApplication {
    @Autowired
...
//    @Bean
    ...
    public static void main(String[] args) {
        SpringApplication.run(NewConsulConsumerApplication.class,args);
    }
